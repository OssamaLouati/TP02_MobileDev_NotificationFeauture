package com.example.louatiapplication;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void onCreate (Bundle savedInstanceState) {
        ...
        btnCreateNotification.setOnClickListener(v -> {
            ...
            PendingIntent snoozePendingIntent = PendingIntent.getBroadcast(MainActivity.this, 0 , snoozeIntent , PendingIntent.FLAG_UPDATE_CURRENT | PendingIntent.FLAG_IMMUTABLE) ;
